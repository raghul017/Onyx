          ...
          <tbody>
            {data.map((row) => {
              ...
              return (
                ...
                >
                  <td className={`px-5 py-3 font-semibold ${isSuccess && !isError ? "!text-[hsl(0_0%_35%)]" : methodColors[row.method] || "text-foreground"}`}>
                    {row.method}
                  </td>
                  ...
                  <td className="px-5 py-3">
                    <span className={`font-bold ${isError ? "text-destructive" : ""}`}>
                      {row.statusCode}
                    </span>
                  </td>
                  <td className="px-5 py-3">
